/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d82c172ea280793800bbec1988b5a11d)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	ENVIRONMENT: "production";
	DATABASE_URL: string;
	USAGE_SYNC_DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DATABASE_URL" | "USAGE_SYNC_DATABASE_URL" | "INTERNAL_ADMIN_SECRET">> {}
}
